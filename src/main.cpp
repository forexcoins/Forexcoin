...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Forexcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "2016 Forexcoin launches and trump wins";
        CTransaction txNew;
        txNew.nTime = 1456473359;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1456473359;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 212009;

	assert(block.hashMerkleRoot == uint256("0x5c865a65ad439adc8071b079527c6c28281b416786fa054ba5e85317fb07bef5"));
